...
This repository contains the paper project introduction and open-source dataset links:

**"SketchMaster: From Rough Lines to Photorealistic Scenes with Adaptive Guidance"**

## Dataset
We open-source the SketchMaster dataset as:

- `SketchMaster_dataset.zip`

Download links:

- Baidu Netdisk: [https://pan.baidu.com/s/14oNxl2Hh8MoI7HzyMf_yaA?pwd=yhif](https://pan.baidu.com/s/14oNxl2Hh8MoI7HzyMf_yaA?pwd=yhif)  
  Extraction code: `yhif`
- Google Drive: [https://drive.google.com/file/d/1kxiPcv7sMlCAoPm3pSqWMEfQ0eiDHNGG/view?usp=sharing](https://drive.google.com/file/d/1kxiPcv7sMlCAoPm3pSqWMEfQ0eiDHNGG/view?usp=sharing)
...
## Repository Contents
- `README.md`: Project introduction and dataset links.
- `static/images/`: Figures used in this README.
- `SketchMaster_dataset.zip`: Public dataset release (download via links above).
